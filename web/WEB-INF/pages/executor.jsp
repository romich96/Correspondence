...
<html>
<head>
    <title>Електронна кореспонденція: довідник виконавців</title>
...
<sec:authorize access="isAuthenticated()">
    <nav id="inhead" class="navbar navbar-default navbar-static-top" style="margin-left: 30px; margin-right: 30px;">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="/executor">Довідники</a></li>
    ...
    <div style="margin-left:30px; margin-right: 30px;">
        <nav class="navbar navbar-default">
            <ul class="nav nav-pills">
                ...
                <li class="active"><a href="/executor">Виконавці</a></li>
            </ul>
        </nav>
        ...
        <div>
            <nav class="navbar navbar-default">
                <ul class="nav nav-pills">
                    <li><a id="add_executor" class="btn btn-default"><span class="glyphicon glyphicon-plus"
                                                                       style="color:green;"></span>
                        Новий</a></li>
                    <li><a id="update_executor" class="btn btn-default"><span class="glyphicon glyphicon-pencil"
                                                                          style="color:orange;"></span> Змінити</a></li>
                    <li><a id="delete_executor" class="btn btn-default"><span class="glyphicon glyphicon-minus"
            ...
            <table id="myTable" class="table table-bordered table-hover" cellspacing="0" width="100%">
                ...
                <c:forEach items="${executors}" var="executor">
                    <tr data-value="${executor.id}">
                        <td>${executor.name}</td>
                    </tr>
                </c:forEach>
                </tbody>

                <form style="display: none" action="/executor_update_page" method="POST" id="formid">
    ...
    <script type="text/javascript">
        ...
        $('#add_executor').click(function () {
            window.location.href = '/executor_add_page';
        })
            ...
            $('#delete_executor').click(function () {
                if (table.rows('.selected').data().length > 0) {
                    if (confirm("Видалити запис?")) {
                        ...
                        $.post("/executor/delete", 'toDelete=' + data);
