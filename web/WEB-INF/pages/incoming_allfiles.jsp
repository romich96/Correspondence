...
<html>
<head>
    <title>Електронна кореспонденція: вхідні файли</title>
    ...
    <div style="margin-left:30px; margin-right: 30px;">
        <nav class="navbar navbar-default">
            <ul class="nav nav-pills">
                <li class="active"><a href="/incoming_allfiles">Вхідні файли</a></li>
        ...
        <div>
            ...
            <table id="myTable" class="table table-hover table-bordered" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td>Дата вхідного</td>
                    <td>Тип вхідного</td>
                    <td>Заголовок вхідного</td>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${incoming_allfiles}" var="file">
                    <tr data-value="${file.id}">
                        ...
                        <td>${file.getIncoming().inDocRegNo}</td>
                        <td>
                            <fmt:formatDate value="${file.getIncoming().inDocRegDate}"
                                            type="date"
                                            pattern="dd.MM.yyyy"
                                            var="theFormattedinDocRegDate"/>
                                            ${theFormattedinDocRegDate}
                        </td>
                        <td>${file.getIncoming().inDocType}</td>
                        <td>${file.getIncoming().inDocTitle}</td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
