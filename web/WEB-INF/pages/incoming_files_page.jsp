...
<html>
<head>
    <title>Електронна кореспонденція: файли вхідного документа</title>
...
<sec:authorize access="isAuthenticated()">
    <div class="container" style="margin-top: 30px;">
        <div class="well">
            <h3>Файли вхідного документа</h3>
            <h4>№ ${incoming.inDocRegNo} від <fmt:formatDate value="${incoming.inDocRegDate}"
                                                             type="date"
                                                             pattern="dd.MM.yyyy"
                                                             var="theFormattedinDocRegDate"/>${theFormattedinDocRegDate} ${incoming.inDocType} ${incoming.inDocTitle} </h4>
        </div>
        ...
        $(function () {
            ...
            var confirmIt = function (e) {
                if (!confirm('Видалити файл?')) {
                    ...
                    $.post("/remove/incoming_file", 'toDelete=' + data);
