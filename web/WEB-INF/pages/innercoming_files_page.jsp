...
<html>
<head>
    <title>Електронна кореспонденція: файли внутрішнього документа</title>
...
<sec:authorize access="isAuthenticated()">
    <div class="container" style="margin-top: 30px;">
        <div class="well">
            <h3>Файли внутрішного документа</h3>
            <h4>№ ${innercoming.innerDocRegNo} від <fmt:formatDate value="${innercoming.innerDocRegDate}"
                                                             type="date"
                                                             pattern="dd.MM.yyyy"
                                                             var="theFormattedinnerDocRegDate"/>${theFormattedinnerDocRegDate} ${innercoming.innerDocType} ${innercoming.innerDocTitle} </h4>
        </div>
            ...
            <table class="table table-hover table-bordered" style="margin-top: 30px" cellspacing="0" width="100%">
                ...
                <c:forEach items="${filesToDelete}" var="file">
                    <tr data-value="${file.id}">
                        ...
                        <td align="center"><a href="/download/innerbox/${file.id}/${file.fileHash}"><span
        ...
        $(function () {
            ...
            var confirmIt = function (e) {
                if (!confirm('Видалити файл?')) {
                    ...
                    $.post("/remove/innercoming_file", 'toDelete=' + data);
