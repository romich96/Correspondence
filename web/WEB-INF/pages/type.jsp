...
<html>
<head>
    <title>Електронна кореспонденція: довідник типів документів</title>
    ...
    <div style="margin-left:30px; margin-right: 30px;">
        <nav class="navbar navbar-default">
            <ul class="nav nav-pills">
                <li class="active"><a href="/type">Типи документів</a></li>
        ...
        <div>
            <nav class="navbar navbar-default">
                <ul class="nav nav-pills">
                    <li><a id="add_type" class="btn btn-default"><span class="glyphicon glyphicon-plus"
                                                                       style="color:green;"></span>
                        Новий</a></li>
                    <li><a id="update_type" class="btn btn-default"><span class="glyphicon glyphicon-pencil"
                                                                          style="color:orange;"></span> Змінити</a></li>
                    <li><a id="delete_type" class="btn btn-default"><span class="glyphicon glyphicon-minus"
            ...
            <table id="myTable" class="table table-bordered table-hover" cellspacing="0" width="100%">
                ...
                <c:forEach items="${types}" var="type">
                    <tr data-value="${type.id}">
                        <td>${type.name}</td>
                    </tr>
                </c:forEach>
                </tbody>

                <form style="display: none" action="/type_update_page" method="POST" id="formid">
            ...
            $('#delete_type').click(function () {
                if (table.rows('.selected').data().length > 0) {
                    if (confirm("Видалити запис?")) {
                        ...
                        $.post("/type/delete", 'toDelete=' + data);
